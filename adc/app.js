...
window.addEventListener('resize', resizeCanvas);
    ...
    const __page2Btn = document.getElementById('page2Btn'); if (__page2Btn) __page2Btn.addEventListener('click', e => { e.stopPropagation(); setVizPage('P1'); });
